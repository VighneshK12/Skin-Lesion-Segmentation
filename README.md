...
Optional: if you want, you can regenerate preprocessing from raw
...
6) Training with ISICTrainer (the main command)
Once env, data, and patch are ready, this is the core command your prof cares about.
